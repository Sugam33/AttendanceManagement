                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Enter Faculty and Section<span class="text-danger ml-2"></span></label>
           <input type="text" class="form-control" name="classArmName" value="<?php echo $row['classArmName'];?>" id="exampleInputFirstName" placeholder="Faculty and Section Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
              ...
              <div class="card mb-4">
               ...
               <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                      <tr>
                        <th>S.N</th>
                        <th>Class Name</th>
                        <th>Faculty and Section Name</th>
                         <th>Status</th>
                        <th>Edit</th>
                        <th>Delete</th>
                      </tr>
