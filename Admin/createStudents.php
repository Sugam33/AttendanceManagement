...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"select * from tblstudents where SymbolNumber ='$SymbolNumber'");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,address,SymbolNumber,classId,classArmId,dateCreated) 
    value('$firstName','$lastName','$address','$SymbolNumber','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    address='$address', SymbolNumber='$SymbolNumber', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" required name="SymbolNumber" value="<?php echo $row['SymbolNumber'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Class Section and Faculty<span class="text-danger ml-2">*</span></label>
                            <?php
