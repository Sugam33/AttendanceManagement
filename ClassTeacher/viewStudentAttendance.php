                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="SymbolNumber" class="form-control mb-3">';
                          echo'<option value="">Select Student</option>';
                          while ($rows = $result->fetch_assoc()){
                          echo'<option value="'.$rows['SymbolNumber'].'" >'.$rows['firstName'].' '.$rows['lastName'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ 
                        ...
                        where tblattendance.SymbolNumber = '$SymbolNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
                       ...
                       if($type == "2"){ 
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.SymbolNumber = tblattendance.SymbolNumber
                        where tblattendance.dateTimeTaken = '$singleDate' and tblattendance.SymbolNumber = '$SymbolNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
                       }
                       if($type == "3"){ 
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.SymbolNumber = tblattendance.SymbolNumber
                        where tblattendance.dateTimeTaken between '$fromDate' and '$toDate' and tblattendance.SymbolNumber = '$SymbolNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
